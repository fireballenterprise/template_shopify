...
- **Shopify theme conventions**: `.github/instructions/shopify.instructions.md`
- **Fireball customization tracking**: `.github/instructions/fireball.instructions.md`
- **Version checks (deps, workflow actions)**: `.github/instructions/versioning.instructions.md`
