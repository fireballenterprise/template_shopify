...
| `properties.py` | Reads `properties.yml` (cached): `get_repo_root()`, `get_properties()`, `get_repo_local()`, `get_repo_remote()`, `get_shopify_store()`, `get_shopify_theme_id_dev()`, `get_shopify_theme_id_prd()`, `get_shopify_local_theme_token()` |
