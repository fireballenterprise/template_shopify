...
- Group related tasks by concern: `tasks/claude.py`, `tasks/dawn.py`, `tasks/repo.py`, `tasks/ruff.py`, `tasks/setup.py`, `tasks/shopify.py`, `tasks/template.py`, `tasks/tests.py`, `tasks/uv.py`, `tasks/versioning.py`
